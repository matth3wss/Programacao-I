...
public class GuessGame {
    ...
    public void startGame(){
        ...
        guessp1=p1.number;
        System.out.println("O jogador um forneceu o palpipe " + guessp1);

        guessp1=p2.number;
        System.out.println("O jogador um forneceu o palpipe " + guessp2);

        guessp1=p3.number;
        System.out.println("O jogador um forneceu o palpipe " + guessp3);
